...
a_filename_out = 'C:\\Users\\sesa751843\\OneDrive - Schneider Electric\\Documents\\Python Programs\\Reset Request\\result_a.txt'  # Output file
b_filename_out = 'C:\\Users\\sesa751843\\OneDrive - Schneider Electric\\Documents\\Python Programs\\Reset Request\\result_b.txt'
...
for line in a_list:
    if count%10 == 0:
        ...
        a_newF.write(')\n')
        a_newF.write(f'Sum{sCount} = Sum(')
    a_newF.write(f'VAVClgRstReq{count},')
    if count == len(a_list):
        a_newF.write(')')
    count+= 1
...
count = 1
for line in a_list:
    a_newF.write(f'Numeric Input VAVClgRstReq{count}\n')
    count+= 1
a_newF.write('\n')
...
# Adding the inputs
for line in a_list:
    a_newF.write(f'<PI Name="VAVClgRstReq{count}">\n')
    a_newF.write(f'\t<Reference DeltaFilter="0" Object="../../../MPV/{line}/Application/Values/ClgRstReq" Property="Priority16" Retransmit="0" TransferRate="10"/>\n')
    a_newF.write(f'</PI>\n')
    count+= 1
a_newF.write('\n')
...
for line in b_list:
    if count%10 == 0:
        ...
        b_newF.write(')\n')
        b_newF.write(f'Sum{sCount} = Sum(')
    b_newF.write(f'VAVClgRstReq{count},')
    if count == len(b_list):
        b_newF.write(')')
    count+= 1
...
count = 1
for line in b_list:
    b_newF.write(f'Numeric Input VAVClgRstReq{count}\n')
    count+= 1
b_newF.write('\n')
...
# Adding the inputs
for line in b_list:
    b_newF.write(f'<PI Name="VAVClgRstReq{count}">\n')
    b_newF.write(f'\t<Reference DeltaFilter="0" Object="../../../MPV/{line}/Application/Values/ClgRstReq" Property="Priority16" Retransmit="0" TransferRate="10"/>\n')
    b_newF.write(f'</PI>\n')
    count+= 1
b_newF.write('\n')
